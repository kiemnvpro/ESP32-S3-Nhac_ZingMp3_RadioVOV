...
namespace Lang {
    ...
    namespace Strings {
        ...
        constexpr const char* KIEMNV_VERSION = "Kiemnv ";
    ...
    namespace Sounds {
        ...
        extern const char ogg_alarm1_start[] asm("_binary_alarm1_ogg_start");
        extern const char ogg_alarm1_end[] asm("_binary_alarm1_ogg_end");
        static const std::string_view OGG_ALARM1 {
        static_cast<const char*>(ogg_alarm1_start),
        static_cast<size_t>(ogg_alarm1_end - ogg_alarm1_start)
        };
        ...
        extern const char ogg_ga_start[] asm("_binary_ga_ogg_start");
        extern const char ogg_ga_end[] asm("_binary_ga_ogg_end");
        static const std::string_view OGG_GA {
        static_cast<const char*>(ogg_ga_start),
        static_cast<size_t>(ogg_ga_end - ogg_ga_start)
        };

        extern const char ogg_iphone_start[] asm("_binary_iphone_ogg_start");
        extern const char ogg_iphone_end[] asm("_binary_iphone_ogg_end");
        static const std::string_view OGG_IPHONE {
        static_cast<const char*>(ogg_iphone_start),
        static_cast<size_t>(ogg_iphone_end - ogg_iphone_start)
        };
